  ...
  return (
    <section>
      ...
      <p>
        ...
        client or server environment. Check for the <code>__CLIENT__</code> and
        <code>__SERVER__</code> flags in your React components to determine
        in which environment you are working.
      </p>
      <p>
        The text generated by this component is made on the { __CLIENT__ ? 'client' : 'server' } in a { __PRODUCTION__ ? 'production' : 'development'} environment.
      </p>
