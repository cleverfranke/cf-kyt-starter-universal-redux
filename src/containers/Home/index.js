  ...
  return (
    <section>
      ...
      <p className={styles.paragraph}>
        ...
        are implemented in this Starter-kyt.
      </p>
      <p className={styles.paragraph}>
        Check out the Addons section for an outline of the changes we made to the
        universal starter kyt in order to better reflect the needs of
